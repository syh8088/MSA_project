...
public class QPaymentOrder extends EntityPathBase<PaymentOrder> {
    ...
    private static final long serialVersionUID = -1050316978L;
    ...
    public final EnumPath<com.order_service.domain.PaymentOrderStatus> status = createEnum("status", com.order_service.domain.PaymentOrderStatus.class);
